...
export default function TwoFAVerifyPage() {
    ...
    const onSubmit = async (data: TotpCodeInput) => {
        if (!factorId) {
            setServerError("No TOTP factor found.");
            return;
        }
        setServerError(null);
            ...
            <div className="w-full max-w-sm">
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 p-8">
                    <div className="text-center mb-6">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{t("verify_title")}</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t("verify_subtitle")}</p>
                    </div>
