...
export default function OnboardingPage() {
    ...
    const submitStep2 = async () => {
        ...
        const supabase = createClient();
        const rows: FacilitySportsInsert[] = sportIds.map((id) => ({
    ...
    // Step 3: Navigate to dashboard — hard navigation bypasses RSC cache so the
    // server re-reads the newly inserted facility row immediately.
    const finish = () => {
            ...
            {step === 2 && (
                <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                        Select all sports available at your facility.
                    </p>
